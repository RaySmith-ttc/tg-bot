...
external interface CloudStorage {
     ...
     * @since Bot API 6.9
     */
    val getItems: (keys: List<String>, callback: (error: String?, values: dynamic) -> Unit) -> Unit
     ...
     * @since Bot API 6.9
     */
    val removeItems: (keys: List<String>, callback: ((error: String?, isRemoved: Boolean?) -> Unit)?) -> Unit
